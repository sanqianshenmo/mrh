...
<script>
import remoteLoad from '@/models/remoteLoad.js'
import { MapKey, MapCityName } from '@/common/config/config'
export default {
  props: ['lat', 'lng'],
  data () {
    return {
    ...
    initMap () {
      ...
      AMapUI.loadUI(['misc/PoiPicker'], PositionPicker => {
        ...
        AMap.service('AMap.PlaceSearch', () => {
          ...
          // var cpoint = [this.lng, this.lat]
          this.placeSearch.search('北京基恩医院')
