    ...
    <div class="box">
     <!-- <div class="shop-list clearfloat"
        ...
        <div v-for="item in apply" v-bind:key="item.id">
          <div class="box-doctory" @click="goToNote(item.noteId)">
            <div class="box-doctory-left">
              <img :src="item.avatar" alt="">
            </div>
            <div class="box-doctory-right">
              <div class="box-doctory-right-top">{{item.nickname}}</div>
              <div class="box-doctory-right-bottom">{{item.update_time}}关注</div>
            </div>
...
export default {
  ...
  methods: {
    ...
    loadMore1 () {
      ...
      this.applyListPage++
      /* USER.userApply(118899712183539, this.applyListPage)
        .then(res => {
