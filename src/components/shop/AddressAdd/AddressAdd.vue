<template>
  <div class="cover-bg" id="addaddress">
      <div class="new-address-pos">
          <div class="new-address-title">添加新地址<span @click="closeAddAddress" class="new-close">X</span></div>
          ...
          <div class="btn address-add-btn bdrx-0" @click="submitAddress" id="submit">保存地址</div>
      </div>
      <my-address
